...
public class Main {
    ...
    static {
         ...
         *  下面这句话其实就相当于new了AlipayClient  DefaultAlipayClient
         *  1.build方法返回 new AlipayTradeServiceImpl(this); 其中this里面有在配置文件里面获取的值
         *  2.new AlipayTradeServiceImpl(this); 有参的构造函数,且继承了AbsAlipayTradeService这个类
         *  3.AbsAlipayTradeService里面有一个AlipayClient client属性 ,
         *  4.new AlipayTradeServiceImpl(this);构造函数里面为这个赋值时,new了一个DefaultAlipayClient
         *  以上四个步骤其实就相当于:
    ...
    public void test_trade_pay(AlipayTradeService service) {
         ...
         * 1.new AlipayTradePayRequestBuilder()无参构造函数
         * 2.不断的set属性
         */
        ...
        /**
         * 调用tradePay方法获取当面付应答
         * service.tradePay(builder)里面的实现做了以下几件事件:
         * 1. new了一个AlipayTradePayRequest request,并且set了属性
         * 2.client去请求数据,将返回的结果封装在了AlipayF2FPayResult里面
         */
